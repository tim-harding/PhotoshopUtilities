/*Inverts the selection if there's a selection, otherwise inverts the current layer's mask*/#target photoshopapp.bringToFront();var main = function(){  if (!activeDocument) return;  var doc = activeDocument;  var docHasSelection = checkSelection(doc);
  try {
    if (docHasSelection) {
